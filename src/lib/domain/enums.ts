...
export const processEventTypes = [
  ...
  "package_submitted",
  "package_completion_operation_started",
  "package_completion_operation_completed",
  "package_completion_reconciled",
  "package_results_generated",
  "package_results_persisted",
  "item_submitted",
  "item_correctness_status_persisted",
  ...
  "profile_feedback_generated",
  "profile_feedback_persisted",
  "student_communication_live_call_started",
  ...
  "student_activity_runtime_started",
  "student_activity_runtime_start_failed",
  ...
  "topic_dialogue_live_call_started",
  "topic_dialogue_live_call_completed",
  "topic_dialogue_fallback_used",
  "topic_dialogue_clarification_requested",
  "topic_dialogue_system_question_answered",
  "topic_dialogue_off_topic_redirected",
  ...
  "student_visible_projection_rejected",
  "raw_id_blocked",
  "alternative_activity_generated",
  "assessment_completed_card_shown",
  "profile_integration_interpreted",
  "student_safe_profile_projection_updated",
  "profile_integration_blocked",
