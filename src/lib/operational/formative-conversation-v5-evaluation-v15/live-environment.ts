...
export const FORMATIVE_CONVERSATION_V5_LIVE_ENVIRONMENT_CONTRACT_VERSION =
  "formative-conversation-v15-live-environment-parity-v1";
...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V15_CANONICAL_SERVICE_NAME",
  "FORMATIVE_CONVERSATION_V5_V15_MIGRATIONS_CURRENT",
  "FORMATIVE_CONVERSATION_V5_V15_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V15_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V15_DATABASE_IDENTITY_MATCHED",
  "FORMATIVE_CONVERSATION_V5_V15_CANONICAL_LAUNCHER_VALIDATED",
  "FORMATIVE_CONVERSATION_V5_V15_CANONICAL_LOADER_VERSION"
] as const;

export const FORMATIVE_CONVERSATION_V15_DATABASE_CANARY_REQUIRED_ENVIRONMENT = [
  ...
  "OPERATIONAL_AGENT_INTEGRATION_EVAL_EVIDENCE_REQUIRED",
  "FORMATIVE_CONVERSATION_V5_V15_CANARY_SESSION_SECRET_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V15_REMOTE_DATABASE_CANARY_ENABLED"
] as const;
...
function parseInjectedEnvironmentKeys(env: NodeJS.ProcessEnv) {
  const value =
    env.FORMATIVE_CONVERSATION_V5_V15_INJECTED_ENVIRONMENT_KEYS;
  assertCondition(
    configured(value),
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const requiredEnvironment = noProviderDatabaseCanary
    ? FORMATIVE_CONVERSATION_V15_DATABASE_CANARY_REQUIRED_ENVIRONMENT
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V15_ENVIRONMENT_SOURCE;
  ...
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V15_LAUNCHER_VERSION",
    FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION
  );
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V15_LAUNCH_MECHANISM",
  ...
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V15_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  assertCondition(
    env.FORMATIVE_CONVERSATION_V5_V15_CANONICAL_SERVICE_NAME !==
      "conversational-mcq-staging",
    "formative_conversation_v15_deprecated_service_forbidden"
  );
  requireExactBoolean(
    env,
    "FORMATIVE_CONVERSATION_V5_V15_MIGRATIONS_CURRENT",
  ...
  if (noProviderDatabaseCanary) {
    ...
    assertCondition(
      ...
      "formative_conversation_v15_canary_provider_credential_injected"
    );
    requireExactString(
      env,
      "FORMATIVE_CONVERSATION_V5_V15_CANARY_SESSION_SECRET_SOURCE",
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V15_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
    for (const sourceName of [
      "FORMATIVE_CONVERSATION_V5_V15_SOURCE_APPROVAL_BUNDLE_PATH",
      "FORMATIVE_CONVERSATION_V5_V15_SOURCE_APPROVED_MANIFEST_PATH",
      "FORMATIVE_CONVERSATION_V5_V15_SOURCE_APPROVAL_EVIDENCE_PATH"
    ]) {
      assertCondition(
