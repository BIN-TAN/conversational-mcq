...
import {
  ...
  FORMATIVE_CONVERSATION_V12_SECURITY_WRAPPER_SOURCE_PATHS,
  FORMATIVE_CONVERSATION_V12_SECURITY_WRAPPER_VERSION,
  formativeConversationV12SecurityWrapperFingerprint
} from "./security-release";
import {
  FORMATIVE_CONVERSATION_V12_RUN_PROVENANCE_VERSION
} from "./provenance";
import {
...
import {
  ...
  FORMATIVE_CONVERSATION_V5_V12_REMOTE_CANARY_EVIDENCE_PATH,
...
const RUNTIME_CANDIDATE_MANIFEST_PATH =
  "config/operational-candidates/formative-conversation-host-v5-executable-v12/runtime-candidate-manifest.json";
...
export function assertFormativeConversationV5RunnerBinding(
  ...
  assertCondition(
    runnerVersion ===
      "formative-conversation-v5-protocol-runner-v12",
...
export function loadFormativeConversationV5EvaluationPackage() {
  ...
  assertCondition(
    ...
    "formative_conversation_v12_v11_launcher_failure_evidence_mismatch"
  );
  ...
  const securityWrapperFingerprint =
    formativeConversationV12SecurityWrapperFingerprint(
      Object.fromEntries(
        FORMATIVE_CONVERSATION_V12_SECURITY_WRAPPER_SOURCE_PATHS.map(
  ...
  assertCondition(
    runtimeCandidateHash === candidateManifest.runtime_candidate_hash &&
      ...
      candidateManifest.runtime_candidate_hash_unchanged &&
      candidateIdentity.runtime_candidate_hash_unchanged &&
      runtimeCandidateHash !==
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      "node --import tsx scripts/operational-formative-conversation-v5-v12-process-local-runner.mjs",
      '--env-fifo "$FORMATIVE_CONVERSATION_V12_ENV_FIFO" --',
      "--mode=live",
