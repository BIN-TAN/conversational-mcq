...
export const FORMATIVE_CONVERSATION_V5_V12_REMOTE_CANARY_EVIDENCE_PATH =
...
export const FORMATIVE_CONVERSATION_V5_PLAN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v12/plans";
export const FORMATIVE_CONVERSATION_V5_RUN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v12/runs";
...
export const FormativeConversationV5FixtureManifestSchema = z
  .object({
    manifest_version: z.literal(
      "formative-conversation-v5-fixture-manifest-v12"
    ),
    ...
    target_identity: z
      .object({
        ...
        run_scoped_provenance_version: z.literal(
          "formative-conversation-v12-run-scoped-committed-source-provenance-v1"
        ),
