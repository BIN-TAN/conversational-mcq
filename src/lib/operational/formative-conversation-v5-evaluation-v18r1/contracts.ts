...
import {
  FORMATIVE_CONVERSATION_V18R1_CONTROL_SCHEMA_VERSION as FORMATIVE_CONVERSATION_V18_CONTROL_SCHEMA_VERSION,
  FORMATIVE_CONVERSATION_V18R1_PREVENTIVE_SCANNER_VERSION as FORMATIVE_CONVERSATION_V18_PREVENTIVE_SCANNER_VERSION,
  FORMATIVE_CONVERSATION_V18R1_RELEASE_POLICY_VERSION as FORMATIVE_CONVERSATION_V18_RELEASE_POLICY_VERSION,
  FORMATIVE_CONVERSATION_V18R1_SCAN_ATTESTATION_SCHEMA_FINGERPRINT as FORMATIVE_CONVERSATION_V18_SCAN_ATTESTATION_SCHEMA_FINGERPRINT,
  FORMATIVE_CONVERSATION_V18R1_SCAN_ATTESTATION_VERSION as FORMATIVE_CONVERSATION_V18_SCAN_ATTESTATION_VERSION,
  FORMATIVE_CONVERSATION_V18R1_SECURITY_WRAPPER_VERSION as FORMATIVE_CONVERSATION_V18_SECURITY_WRAPPER_VERSION
...
export const FORMATIVE_CONVERSATION_V5_EVALUATION_RUNNER_VERSION =
  "formative-conversation-v5-protocol-runner-v18r1";
export const FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT =
  "config/operational-candidates/formative-conversation-host-v5-executable-v18r1";
...
export const FORMATIVE_CONVERSATION_V5_PLAN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v18r1/plans";
export const FORMATIVE_CONVERSATION_V5_RUN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v18r1/runs";
