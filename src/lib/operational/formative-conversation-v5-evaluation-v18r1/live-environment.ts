...
export const FORMATIVE_CONVERSATION_V5_LIVE_ENVIRONMENT_CONTRACT_VERSION =
  "formative-conversation-v18r1-live-environment-parity-v1";
export const FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION =
  "formative-conversation-v5-canonical-node-import-tsx-launcher-v18r1";
export const FORMATIVE_CONVERSATION_V5_LAUNCH_MECHANISM =
  "node --import tsx";
export const FORMATIVE_CONVERSATION_V5_CANONICAL_LOADER_VERSION =
  "formative-conversation-v18r1-canonical-node-import-tsx-v1";
...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V18R1_MIGRATIONS_CURRENT",
  "FORMATIVE_CONVERSATION_V5_V18R1_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V18R1_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V18R1_DATABASE_IDENTITY_MATCHED",
  "FORMATIVE_CONVERSATION_V5_V18R1_CANONICAL_LAUNCHER_VALIDATED",
  "FORMATIVE_CONVERSATION_V5_V18R1_CANONICAL_LOADER_VERSION"
] as const;

export const FORMATIVE_CONVERSATION_V18R1_DATABASE_CANARY_REQUIRED_ENVIRONMENT = [
  ...
  "OPERATIONAL_AGENT_INTEGRATION_EVAL_EVIDENCE_REQUIRED",
  "FORMATIVE_CONVERSATION_V5_V18R1_CANARY_SESSION_SECRET_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V18R1_REMOTE_DATABASE_CANARY_ENABLED"
] as const;
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const requiredEnvironment = noProviderDatabaseCanary
    ? FORMATIVE_CONVERSATION_V18R1_DATABASE_CANARY_REQUIRED_ENVIRONMENT
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V18R1_ENVIRONMENT_SOURCE;
  ...
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V18R1_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  assertCondition(
    env.FORMATIVE_CONVERSATION_V5_V18R1_CANONICAL_SERVICE_NAME !==
      "conversational-mcq-staging",
    "formative_conversation_v18r1_deprecated_service_forbidden"
  );
  requireExactBoolean(
    env,
    "FORMATIVE_CONVERSATION_V5_V18R1_MIGRATIONS_CURRENT",
  ...
  if (noProviderDatabaseCanary) {
    ...
    assertCondition(
      ...
      "formative_conversation_v18r1_canary_provider_credential_injected"
    );
    requireExactString(
      env,
      "FORMATIVE_CONVERSATION_V5_V18R1_CANARY_SESSION_SECRET_SOURCE",
  ...
  assertCondition(
    ...
    "formative_conversation_v18r1_active_profiling_role_unavailable"
  );
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V18R1_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
    for (const sourceName of [
      "FORMATIVE_CONVERSATION_V5_V18R1_SOURCE_APPROVAL_BUNDLE_PATH",
      "FORMATIVE_CONVERSATION_V5_V18R1_SOURCE_APPROVED_MANIFEST_PATH",
      "FORMATIVE_CONVERSATION_V5_V18R1_SOURCE_APPROVAL_EVIDENCE_PATH"
    ]) {
      assertCondition(
