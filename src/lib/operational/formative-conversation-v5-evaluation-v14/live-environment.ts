...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V14_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V14_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V14_DATABASE_IDENTITY_MATCHED",
  "FORMATIVE_CONVERSATION_V5_V14_CANONICAL_LAUNCHER_VALIDATED",
  "FORMATIVE_CONVERSATION_V5_V14_CANONICAL_LOADER_VERSION"
] as const;

export const FORMATIVE_CONVERSATION_V14_DATABASE_CANARY_REQUIRED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V14_CANARY_SESSION_SECRET_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V14_REMOTE_DATABASE_CANARY_ENABLED"
] as const;
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const requiredEnvironment = noProviderDatabaseCanary
    ? FORMATIVE_CONVERSATION_V14_DATABASE_CANARY_REQUIRED_ENVIRONMENT
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V14_ENVIRONMENT_SOURCE;
  ...
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V14_LAUNCHER_VERSION",
    FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION
  );
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V14_LAUNCH_MECHANISM",
  ...
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V14_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  if (noProviderDatabaseCanary) {
    ...
    assertCondition(
      ...
      "formative_conversation_v14_canary_provider_credential_injected"
    );
    requireExactString(
      env,
      "FORMATIVE_CONVERSATION_V5_V14_CANARY_SESSION_SECRET_SOURCE",
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V14_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
    for (const sourceName of [
      "FORMATIVE_CONVERSATION_V5_V14_SOURCE_APPROVAL_BUNDLE_PATH",
      "FORMATIVE_CONVERSATION_V5_V14_SOURCE_APPROVED_MANIFEST_PATH",
      "FORMATIVE_CONVERSATION_V5_V14_SOURCE_APPROVAL_EVIDENCE_PATH"
    ]) {
      assertCondition(
