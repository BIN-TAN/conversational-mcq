...
export const FORMATIVE_CONVERSATION_V5_V14_REMOTE_CANARY_EVIDENCE_PATH =
...
export const FORMATIVE_CONVERSATION_V5_V11_LAUNCHER_FAILURE_ANALYSIS_PATH =
  `${FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT}/v11-launcher-failure-analysis.json`;
export const FORMATIVE_CONVERSATION_V5_V13_CASE5_EVIDENCE_CLOSURE_REPLAY_PATH =
  `${FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT}/regressions/immutable-v13-case5-evidence-closure-replay.json`;
export const FORMATIVE_CONVERSATION_V5_V13_FAILURE_ANALYSIS_PATH =
  `${FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT}/v13-failure-analysis.json`;
export const FORMATIVE_CONVERSATION_V5_PLAN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v14/plans";
...
export const FormativeConversationV5FixtureManifestSchema = z
  .object({
    manifest_version: z.literal(
      "formative-conversation-v5-fixture-manifest-v14"
    ),
  ...
  .object({
    ...
    target_identity: z
      .object({
        ...
        candidate_acceptance_version: z.literal(
          "formative-conversation-candidate-acceptance-v1"
        ),
        adversarial_matrix_version: z.literal(
          "formative-conversation-v13-adversarial-offline-matrix-v1"
        ),
        adversarial_matrix_hash: HashSchema,
        ...
        transition_evidence_closure_version: z.literal(
          "formative-conversation-transition-evidence-closure-v1"
        ),
        evaluation_accounting_version: z.literal(
        ...
        run_scoped_provenance_version: z.literal(
          "formative-conversation-v13-run-scoped-committed-source-provenance-v1"
        ),
            ...
            z
              .object({
                role: z.enum([
                  ...
                  "candidate_acceptance_boundary",
                  "adversarial_offline_matrix",
                  "immutable_v12_fcv5_02_first_principles_adaptation",
                  "immutable_v12_fcv5_03_direct_answer_handling",
                  "provider_adapter",
                  "provider_adapter_identity",
                  "provider_transport_diagnostics",
                  "opening_validator",
                  "profile_transition_validator",
                  "transition_evidence_closure",
                  ...
                  "immutable_v13_case5_evidence_closure_replay",
                  "v13_failure_analysis"
                ]),
                path: z.string().min(1),
                sha256: HashSchema
              })
    ...
    artifact_contract: z
      .object({
        ...
        v11_launcher_failure_analysis_path: z.literal(
          FORMATIVE_CONVERSATION_V5_V11_LAUNCHER_FAILURE_ANALYSIS_PATH
        ),
        v11_launcher_failure_analysis_sha256: HashSchema
      })
      .strict(),
...
export const FormativeConversationV5CandidateManifestSchema = z
  .object({
    ...
    activation_permitted: z.literal(false),
    runtime_behavior_changed: z.literal(true),
    ...
    source_candidate_manifest: z
      ...
      .strict(),
    runtime_candidate_hash: HashSchema,
    runtime_candidate_hash_unchanged: z.literal(false),
    ...
    frozen_v12_runtime_candidate_hash: z.literal(
      "2e85c274e3c89d98ee5cbe60516f9cb91f33504ce2045eed63f762d329512b6c"
    ),
    frozen_v12_protocol_hash: z.literal(
      "72e0c28ea5b1735c28baa83f97843280795bad4c818bcf79b2590dae81c956cd"
    ),
    immutable_v12_opening_failure_evidence: z
      .array(
        z
          .object({
            case_id: z.enum([
...
export const FormativeConversationV5BlockedV11LauncherFailureSchema = z
  .object({
    artifact_version: z.literal(
    ...
    source_commit_sha: Sha40Schema,
    runtime_candidate_hash: HashSchema,
    evaluation_protocol_hash: z.literal(
      "b4053264bcc2caf72a7e77ff34ae1f90be17fdebb0a0857f09c98a15c293e6b5"
    ),
    status: z.literal("blocked_before_dispatch"),
    frozen_command: z.string().min(1),
    observed_error_code: z.literal("ERR_MODULE_NOT_FOUND"),
    root_cause: z.string().min(1),
    verification_gap: z.string().min(1),
    correction_scope: z.string().min(1),
    dispatch_checkpoint_created: z.literal(false),
    provider_run_id: z.null(),
    derived_evaluation_id: z.null(),
    provider_calls: z.literal(0),
    model_auth_requests: z.literal(0),
    synthetic_records_created: z.literal(0),
    approval_eligible: z.literal(false),
    activation_permitted: z.literal(false),
    rerunnable_as_v11: z.literal(false),
    preserved_immutable: z.literal(true)
  })
  .strict();
...
export const FormativeConversationV5LiveEnvironmentContractSchema = z
  .object({
    contract_version: z.literal(
      "formative-conversation-v5-live-environment-parity-v2"
    ),
    launcher: z
      .object({
        version: z.literal(
        ...
        module_probe_environment_preflight_plan_and_live_share_loader:
          z.literal(true),
        bare_node_fails_typed_before_dispatch: z.literal(true),
        invalid_invocation_error_code: z.literal(
