...
export const FORMATIVE_CONVERSATION_V5_LIVE_ENVIRONMENT_CONTRACT_VERSION =
  "formative-conversation-v18r2-live-environment-parity-v1";
...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "RENDER_GIT_COMMIT",
  "FORMATIVE_CONVERSATION_V5_V18R2_PROVENANCE_MODE",
  "FORMATIVE_CONVERSATION_V5_V18R2_CANONICAL_SERVICE_NAME",
  "FORMATIVE_CONVERSATION_V5_V18R2_MIGRATIONS_CURRENT",
  "FORMATIVE_CONVERSATION_V5_V18R2_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V18R2_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V18R2_DATABASE_IDENTITY_MATCHED",
  "FORMATIVE_CONVERSATION_V5_V18R2_CANONICAL_LAUNCHER_VALIDATED",
  "FORMATIVE_CONVERSATION_V5_V18R2_CANONICAL_LOADER_VERSION"
] as const;

export const FORMATIVE_CONVERSATION_V18R2_DATABASE_CANARY_REQUIRED_ENVIRONMENT = [
  ...
  "OPERATIONAL_AGENT_INTEGRATION_EVAL_EVIDENCE_REQUIRED",
  "FORMATIVE_CONVERSATION_V5_V18R2_CANARY_SESSION_SECRET_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V18R2_REMOTE_DATABASE_CANARY_ENABLED"
] as const;
...
function parseInjectedEnvironmentKeys(env: NodeJS.ProcessEnv) {
  const value =
    env.FORMATIVE_CONVERSATION_V5_V18R2_INJECTED_ENVIRONMENT_KEYS;
  assertCondition(
    configured(value),
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const requiredEnvironment = noProviderDatabaseCanary
    ? FORMATIVE_CONVERSATION_V18R2_DATABASE_CANARY_REQUIRED_ENVIRONMENT
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V18R2_ENVIRONMENT_SOURCE;
  ...
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V18R2_LAUNCHER_VERSION",
    FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION
  );
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V18R2_LAUNCH_MECHANISM",
  ...
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V18R2_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  assertCondition(
    env.FORMATIVE_CONVERSATION_V5_V18R2_CANONICAL_SERVICE_NAME !==
      "conversational-mcq-staging",
    "formative_conversation_v18r2_deprecated_service_forbidden"
  );
  requireExactBoolean(
    env,
    "FORMATIVE_CONVERSATION_V5_V18R2_MIGRATIONS_CURRENT",
  ...
  if (noProviderDatabaseCanary) {
    ...
    assertCondition(
      ...
      "formative_conversation_v18r2_canary_provider_credential_injected"
    );
    requireExactString(
      env,
      "FORMATIVE_CONVERSATION_V5_V18R2_CANARY_SESSION_SECRET_SOURCE",
  ...
  assertCondition(
    ...
    "formative_conversation_v18r2_active_profiling_role_unavailable"
  );
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V18R2_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
