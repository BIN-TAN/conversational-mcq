...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V8_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V8_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V8_DATABASE_IDENTITY_MATCHED"
] as const;
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V8_ENVIRONMENT_SOURCE;
  ...
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V8_LAUNCHER_VERSION",
    FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION
  );
  requireExactString(
    env,
    "FORMATIVE_CONVERSATION_V5_V8_LAUNCH_MECHANISM",
    FORMATIVE_CONVERSATION_V5_LAUNCH_MECHANISM
  );
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V8_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V8_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
    for (const sourceName of [
      "FORMATIVE_CONVERSATION_V5_V8_SOURCE_APPROVAL_BUNDLE_PATH",
      "FORMATIVE_CONVERSATION_V5_V8_SOURCE_APPROVED_MANIFEST_PATH",
      "FORMATIVE_CONVERSATION_V5_V8_SOURCE_APPROVAL_EVIDENCE_PATH"
    ]) {
      assertCondition(
