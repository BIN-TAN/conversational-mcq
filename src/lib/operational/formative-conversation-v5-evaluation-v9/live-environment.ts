...
export const FORMATIVE_CONVERSATION_V5_REQUIRED_INJECTED_ENVIRONMENT = [
  ...
  "FORMATIVE_CONVERSATION_V5_V9_LIVE_EVALUATION_ENABLED",
  "FORMATIVE_CONVERSATION_V5_V9_DATABASE_CONNECTION_SOURCE",
  "FORMATIVE_CONVERSATION_V5_V9_DATABASE_IDENTITY_MATCHED"
] as const;

export const FORMATIVE_CONVERSATION_V9_DATABASE_CANARY_REQUIRED_ENVIRONMENT = [
...
export function validateFormativeConversationV5LiveEnvironment(
  ...
  const environmentSource =
    env.FORMATIVE_CONVERSATION_V5_V9_ENVIRONMENT_SOURCE;
  ...
  const databaseConnectionSource =
    env.FORMATIVE_CONVERSATION_V5_V9_DATABASE_CONNECTION_SOURCE;
  assertCondition(
  ...
  if (noProviderDatabaseCanary) {
    ...
    assertCondition(
      ...
      "formative_conversation_v9_canary_provider_credential_injected"
    );
    requireExactString(
      env,
      "FORMATIVE_CONVERSATION_V5_V9_CANARY_SESSION_SECRET_SOURCE",
  ...
  const projectionUsed =
    env.FORMATIVE_CONVERSATION_V5_V9_APPROVAL_PATH_PROJECTION_USED ===
    "true";
  if (projectionUsed) {
