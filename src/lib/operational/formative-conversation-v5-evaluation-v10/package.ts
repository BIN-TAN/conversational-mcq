...
import {
  ...
  FORMATIVE_CONVERSATION_V5_V10_REMOTE_CANARY_EVIDENCE_PATH,
...
const RUNTIME_CANDIDATE_MANIFEST_PATH =
  "config/operational-candidates/formative-conversation-host-v5-executable-v10/runtime-candidate-manifest.json";
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      "npm run operational:formative-conversation-v5-v10-evaluate --",
      "--mode=live",
