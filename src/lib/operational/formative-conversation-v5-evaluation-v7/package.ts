...
const RUNTIME_CANDIDATE_MANIFEST_PATH =
  "config/operational-candidates/formative-conversation-host-v5-executable-v7/runtime-candidate-manifest.json";
...
export function assertFormativeConversationV5RunnerBinding(
  ...
  assertCondition(
    runnerVersion ===
      "formative-conversation-v5-protocol-runner-v7",
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      "npm run operational:formative-conversation-v5-v7-evaluate --",
      "--mode=live",
