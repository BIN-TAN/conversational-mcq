...
export const FORMATIVE_CONVERSATION_V5_EVALUATION_RUNNER_VERSION =
  "formative-conversation-v5-protocol-runner-v16";
...
export const FORMATIVE_CONVERSATION_V5_INHERITED_V15_REFERENCE_PATH =
  `${FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT}/inherited-v15-reference.json`;
export const FORMATIVE_CONVERSATION_V5_IMMUTABLE_V15_REPLAY_REFERENCE_PATH =
...
export const FORMATIVE_CONVERSATION_V5_PLAN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v16/plans";
export const FORMATIVE_CONVERSATION_V5_RUN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v16/runs";
