...
function fixture(input: {
  ...
  order: number;
  title: string;
  persona: FormativeConversationV5Fixture["execution_persona_id"];
  ...
  return {
    ...
    title: input.title,
    execution_persona_id: input.persona,
    synthetic_only: true,
    ...
    synthetic_identity: {
      ...
      student_identity_template: `<provider_run_id>:${input.persona}`
    },
    assessment: {
...
export const formativeConversationV5FixtureSources: readonly FixtureWithoutHash[] =
  [
    fixture({
      case_id: "fcv5_01_assistant_first_opening",
      order: 1,
      title: "Assistant-first opening",
      persona: "correct_shallow",
      responses: [
        response({
          item: 1,
          selected: "A",
    ...
    fixture({
      ...
      persona: "high_performing_extension",
      responses: [
        response({
          item: 1,
          selected: "A",
    ...
    fixture({
      ...
      persona: "confident_misconception",
      responses: [
        response({
          item: 1,
          selected: "B",
    ...
    fixture({
      ...
      persona: "persistent_non_improvement",
      responses: [
        response({
          item: 1,
          selected: "B",
    ...
    fixture({
      ...
      persona: "fragmented_inconsistent",
      responses: [
        response({
          item: 1,
          selected: "A",
