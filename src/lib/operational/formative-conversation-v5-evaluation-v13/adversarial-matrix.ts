...
export const FORMATIVE_CONVERSATION_V13_ADVERSARIAL_MATRIX_VERSION =
  "formative-conversation-v13-adversarial-offline-matrix-v1";

export const formativeConversationV13AdversarialMatrix = {
  matrix_version: FORMATIVE_CONVERSATION_V13_ADVERSARIAL_MATRIX_VERSION,
...
export const FORMATIVE_CONVERSATION_V13_ADVERSARIAL_MATRIX_HASH = stableHash(
