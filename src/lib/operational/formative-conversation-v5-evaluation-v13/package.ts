...
const RUNTIME_CANDIDATE_MANIFEST_PATH =
  "config/operational-candidates/formative-conversation-host-v5-executable-v13/runtime-candidate-manifest.json";
...
export function assertFormativeConversationV5RunnerBinding(
  ...
  assertCondition(
    runnerVersion ===
      "formative-conversation-v5-protocol-runner-v13",
...
export function loadFormativeConversationV5EvaluationPackage() {
  ...
  assertCondition(
    ...
    "formative_conversation_v13_v11_launcher_failure_evidence_mismatch"
  );
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      "node --import tsx scripts/operational-formative-conversation-v5-v13-process-local-runner.mjs",
      '--env-fifo "$FORMATIVE_CONVERSATION_V13_ENV_FIFO" --',
      "--mode=live",
