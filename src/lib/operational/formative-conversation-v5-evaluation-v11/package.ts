...
import {
  ...
  FORMATIVE_CONVERSATION_V11_SECURITY_WRAPPER_SOURCE_PATHS,
  FORMATIVE_CONVERSATION_V11_SECURITY_WRAPPER_VERSION,
  formativeConversationV11SecurityWrapperFingerprint
} from "./security-release";
import {
  FORMATIVE_CONVERSATION_V11_RUN_PROVENANCE_VERSION
} from "./provenance";
import {
...
export function loadFormativeConversationV5EvaluationPackage() {
  ...
  const securityWrapperFingerprint =
    formativeConversationV11SecurityWrapperFingerprint(
      Object.fromEntries(
        FORMATIVE_CONVERSATION_V11_SECURITY_WRAPPER_SOURCE_PATHS.map(
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      ...
      '--env-fifo "$FORMATIVE_CONVERSATION_V11_ENV_FIFO" --',
      "--mode=live",
