...
function fixture(input: {
  ...
  return {
    ...
    call_graph: {
      ...
      maximum_logical_calls: logicalCalls.length + 1,
...
export const formativeConversationV5FixtureSources = [
    ...
    fixture({
      ...
      order: 5,
      title: "Meaningful transition with unresolved SEM evidence",
      ...
      assertions: [
        ...
        assertion(
          "largely_improved_when_sem_unresolved",
          "The student may be largely improved, but sound understanding is not supported while the standard-error distinction remains untested.",
          "deterministic_artifact_check"
        ),
        assertion(
