...
const RUNTIME_CANDIDATE_MANIFEST_PATH =
  "config/operational-candidates/formative-conversation-host-v5-executable-v4/runtime-candidate-manifest.json";
  ...
  assertCondition(
    candidateManifest.compiled_execution_plan_path ===
      ...
      protocol.compiled_execution_plan_path ===
        FORMATIVE_CONVERSATION_V5_COMPILED_PLAN_PATH,
    "formative_conversation_v5_v4_compiled_plan_path_mismatch"
  );
  assertCondition(
...
export function buildFormativeConversationV5EvaluationPlan() {
  ...
  return {
    ...
    required_live_command: [
      ...
      "npm run operational:formative-conversation-v5-v4-evaluate --",
      "--mode=live",
