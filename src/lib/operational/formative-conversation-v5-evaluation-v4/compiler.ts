...
export function compileFormativeConversationV5ExecutionPlan(
  ...
  assertCondition(
    ...
    "formative_conversation_v5_v4_fixture_inventory_not_exact"
  );
  assertCondition(
    fixtures.every(
      (fixture, index) =>
    ...
    "formative_conversation_v5_v4_case_order_mismatch"
  );
  assertCondition(
    new Set(
      fixtures.map((fixture) => fixture.execution_subject_id)
    ).size === fixtures.length,
    "formative_conversation_v5_v4_execution_subject_collision"
  );
  ...
  assertCondition(
    ...
    "formative_conversation_v5_v4_assessment_definition_mismatch"
  );
  ...
  assertCondition(
    ...
    "formative_conversation_v5_v4_case_namespace_collision"
  );
      ...
      input.budget.maximum_provider_attempt_count ===
        expectedLogicalCallCount *
          (input.budget
            ...
            1),
    "formative_conversation_v5_v4_aggregate_call_graph_mismatch"
  );
...
export function assertFormativeConversationV5CompiledPlanHash(
  ...
  assertCondition(
    ...
    "formative_conversation_v5_v4_compiled_plan_hash_mismatch"
  );
}
...
export function assertFormativeConversationV5CompilationParity(input: {
  ...
  assertCondition(
    ...
    "formative_conversation_v5_v4_plan_live_compilation_mismatch"
  );
}
