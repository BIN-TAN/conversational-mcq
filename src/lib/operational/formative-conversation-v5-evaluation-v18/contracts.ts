...
import {
  ...
  FORMATIVE_CONVERSATION_V18_SECURITY_WRAPPER_VERSION
...
export const FORMATIVE_CONVERSATION_V5_EVALUATION_ROOT =
  "config/operational-candidates/formative-conversation-host-v5-executable-v18";
...
export const FORMATIVE_CONVERSATION_V5_IMMUTABLE_V17_REFERENCE_PATH =
...
export const FORMATIVE_CONVERSATION_V5_PLAN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v18/plans";
export const FORMATIVE_CONVERSATION_V5_RUN_OUTPUT_ROOT =
  ".data/operational-formative-conversation-v5-evaluation-v18/runs";
