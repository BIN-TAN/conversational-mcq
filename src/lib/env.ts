...
const serverEnvSchema = z.object({
  ...
  OPENAI_MODEL_FORMATIVE_VALUE_DETERMINATION: z.string().optional(),
  OPENAI_MODEL_FOLLOWUP: z.string().optional(),
  OPENAI_MODEL_FORMATIVE_ACTIVITY_DIALOGUE: z.string().optional(),
  OPENAI_MODEL_FORMATIVE_ACTIVITY_QUALITY_REVIEWER: z.string().optional(),
  OPENAI_MODEL_FORMATIVE_ACTIVITY_RESPONSE_EVALUATOR: z.string().optional(),
  OPENAI_MODEL_POST_ACTIVITY_EVIDENCE_EVALUATOR: z.string().optional(),
  OPENAI_MODEL_STUDENT_COMMUNICATION: z.string().optional(),
  OPENAI_MODEL_TOPIC_DIALOGUE: z.string().optional(),
  OPENAI_MODEL_FORMATIVE_CONVERSATION: z.string().optional(),
  ...
  OPENAI_REASONING_EFFORT_FORMATIVE_VALUE_DETERMINATION: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_FOLLOWUP: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_FORMATIVE_ACTIVITY_DIALOGUE: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_FORMATIVE_ACTIVITY_QUALITY_REVIEWER: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_FORMATIVE_ACTIVITY_RESPONSE_EVALUATOR: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_POST_ACTIVITY_EVIDENCE_EVALUATOR: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_STUDENT_COMMUNICATION: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_TOPIC_DIALOGUE: optionalOpenAiReasoningEffort,
  OPENAI_REASONING_EFFORT_FORMATIVE_CONVERSATION: optionalOpenAiReasoningEffort,
  ...
  OPENAI_MAX_OUTPUT_TOKENS_FORMATIVE_VALUE_DETERMINATION: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_FOLLOWUP: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_FORMATIVE_ACTIVITY_DIALOGUE: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_FORMATIVE_ACTIVITY_QUALITY_REVIEWER: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_FORMATIVE_ACTIVITY_RESPONSE_EVALUATOR: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_POST_ACTIVITY_EVIDENCE_EVALUATOR: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_STUDENT_COMMUNICATION: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_TOPIC_DIALOGUE: optionalPositiveInt,
  OPENAI_MAX_OUTPUT_TOKENS_FORMATIVE_CONVERSATION: optionalPositiveInt,
  ...
  STUDENT_COMMUNICATION_LIVE_CALLS_ENABLED: booleanWithDefault(false),
  TOPIC_DIALOGUE_LIVE_CALLS_ENABLED: booleanWithDefault(false),
  FORMATIVE_CONVERSATION_LIVE_CALLS_ENABLED: booleanWithDefault(false),
  TOPIC_DIALOGUE_MAX_STUDENT_TURNS: optionalPositiveInt,
  TOPIC_DIALOGUE_RECENT_TURN_WINDOW: optionalPositiveInt,
  TOPIC_DIALOGUE_MAX_STUDENT_MESSAGE_CHARS: positiveIntWithDefault(5000),
  TOPIC_DIALOGUE_ALLOW_ASSESSMENT_SYSTEM_QUESTIONS: booleanWithDefault(true),
  ...
  OPERATIONAL_APPROVAL_BUNDLE_PATH: z.string().optional(),
  OPERATIONAL_APPROVED_MANIFEST_PATH: z.string().optional(),
  OPERATIONAL_APPROVAL_EVIDENCE_PATH: z.string().optional(),
