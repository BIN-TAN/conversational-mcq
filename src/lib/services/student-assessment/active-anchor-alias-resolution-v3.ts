...
import {
  ...
  AnchorStanceResolutionV1Schema,
  resolveAnchorStanceV1,
  type PriorStudentAnchorReasoning
...
export const ACTIVE_ANCHOR_ALIAS_RESOLUTION_VERSION_V3 =
  "active-anchor-alias-resolution-v3" as const;
...
export const ActiveAnchorAliasResolutionV3Schema = z.object({
  resolver_version: z.literal(ACTIVE_ANCHOR_ALIAS_RESOLUTION_VERSION_V3),
  reference_resolver_version: z.literal(
    ACTIVE_ANCHOR_ALIAS_RESOLUTION_VERSION
  ),
  stance_resolver_version: z.literal(ANCHOR_STANCE_RESOLUTION_VERSION),
  ...
  independent_stance_resolution: AnchorStanceResolutionV1Schema,
...
export type ActiveAnchorAliasResolutionV3 = z.infer<
  typeof ActiveAnchorAliasResolutionV3Schema
>;
...
function resolvePriorReasoning(input: {
  ...
  return input.messages.map((message) => {
    ...
    const stance = resolveAnchorStanceV1({
      message,
      contract: input.contract,
...
export function resolveActiveAnchorAliasV3(input: {
  message: string;
  contract: ActiveAnchorAliasContract;
  ...
  return ActiveAnchorAliasResolutionV3Schema.parse({
    ...
    independent_stance_resolution: stance,
