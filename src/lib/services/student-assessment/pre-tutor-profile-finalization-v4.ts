...
export const PRE_TUTOR_PROFILE_FINALIZATION_VERSION_V4 =
  "pre-tutor-profile-finalization-v4" as const;

export const PreTutorProfileFinalizationAttestationV4Schema = z.object({
  finalization_version: z.literal(PRE_TUTOR_PROFILE_FINALIZATION_VERSION_V4),
  ...
  profile_mapper_version: z.literal(TURN_EVIDENCE_PROFILE_MAPPER_VERSION_V7),
  profile_consistency_version: z.literal(
    PROFILE_CONSISTENCY_POLICY_VERSION_V7
  ),
  evidence_preservation_contract_version: z.literal(
    TARGET_EVIDENCE_MAPPER_PRESERVATION_VERSION
  ),
  ...
  evidence_preservation_passed: z.literal(true),
  ...
  execution_order: z.tuple([
    ...
    z.literal("mapper_evidence_preservation_verified"),
...
export type PreTutorProfileFinalizationAttestationV4 = z.infer<
  typeof PreTutorProfileFinalizationAttestationV4Schema
>;
...
export function finalizeEvidenceFirstTurnBeforeTutorV4(input: {
  ...
  const mappedObservation = mapTargetEvidenceAdjudicationToObservationV7({
    contract,
    adjudication,
  ...
  const attestation = PreTutorProfileFinalizationAttestationV4Schema.parse({
    ...
    evidence_preservation_passed: consistency.evidence_preservation.passed,
    ...
    execution_order: [
      ...
      "mapper_evidence_preservation_verified",
