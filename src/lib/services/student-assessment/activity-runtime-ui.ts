...
function projectionForNoAttempt(): StudentActivityRuntimeProjection {
  const projection: StudentActivityRuntimeProjection = {
    ...
    status_message: "A short activity can be prepared when you are ready.",
    focus_label: null,
    first_turn_message: null,
    response_prompt: null,
    helper_text: "Prepare the activity when you are ready to respond.",
    allowed_actions: ["start_activity"],
    can_start: true,
