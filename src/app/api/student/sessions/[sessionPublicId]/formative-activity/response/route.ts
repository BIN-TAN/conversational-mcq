...
import {
  StudentAssessmentServiceError
} from "@/lib/services/student-assessment/errors";
import { submitFormativeActivityResponse } from "@/lib/services/student-assessment/service";
...
export async function POST(
  ...
  try {
    ...
    const result = await submitFormativeActivityResponse({
