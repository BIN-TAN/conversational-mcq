...
import { confirmAllEvalAnnotationsForRun } from "@/lib/services/evals/annotation-adjudication";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      await confirmAllEvalAnnotationsForRun(params.runPublicId, await request.json(), auth.user)
    );
  } catch (error) {
