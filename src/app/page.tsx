...
const links = [
  ...
  },
  {
    ...
    description:
      "Instructor access for student account management, session review, evidence audit, and research-data export.",
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10">
        <section className="rounded-lg border border-border-light bg-panel-gray p-6 md:p-8">
          ...
          <p className="mt-6 text-sm font-semibold uppercase tracking-wide text-ualberta-green">
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-muted">
            Conversational MCQ activity for measurement theory practice, response explanation, and
            instructor review.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-border-light bg-ualberta-gold-soft p-5 text-sm leading-6 text-ink">
          <h2 className="font-semibold text-ualberta-green-dark">Course access instruction</h2>
          <p className="mt-1 text-muted">
            Use the classroom ID and access credential provided by the instructor. This site supports
            the EDPY 507 course activity and instructor review workflow.
          </p>
        </section>
      </div>
    </main>
