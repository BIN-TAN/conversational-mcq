import { ForgotPasswordClient } from "@/components/account-security/forgot-password-client";
    ...
    <main className="flex min-h-screen items-center justify-center bg-panel-gray px-6 py-10">
      <section className="w-full max-w-md overflow-hidden rounded-lg border border-border-light bg-white shadow-soft">
        ...
        <div className="p-6">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-ink">Forgot teacher password</h1>
          <div className="mt-6">
