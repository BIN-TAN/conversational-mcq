...
Synthetic pipeline validation is available through `npm run student:synthetic-research-validation -- --mode=plan`; an explicitly authorized live run composes the production profiling, formative-conversation, teacher-review, and research-export services. See [Synthetic Student Research Validation](docs/SYNTHETIC_STUDENT_RESEARCH_VALIDATION.md).
