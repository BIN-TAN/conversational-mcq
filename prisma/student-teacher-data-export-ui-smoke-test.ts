...
function main() {
  ...
  assertIncludes(unifiedClient, "Search variable name", "Unified research export client");
  assertIncludes(unifiedClient, "Search event name", "Unified research export client");
  ...
  assertNotIncludes(unifiedClient, "How the data are produced", "Unified research export client");
  assertNotIncludes(unifiedClient, "Deprecated status", "Unified research export client");
  assertIncludes(unifiedClient, "Learning-process event definitions", "Unified research export client");
  assertIncludes(unifiedClient, "Internal database schema", "Unified research export client");
  assertIncludes(unifiedClient, "Excluded platform and security fields", "Unified research export client");
