...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v7/fixture-source";
import {
...
if (
  ...
  throw new Error(
    "formative_conversation_v5_v7_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v7_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    path: "scripts/operational-formative-conversation-v5-v7-launcher.mjs",
    child_cli_path:
      "prisma/operational-formative-conversation-v5-v7-evaluate.ts",
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v7",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V7_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v7/live-environment.ts",
    launch_mechanism:
      "scripts/operational-formative-conversation-v5-v7-launcher.mjs",
    secure_process_local_injection:
      "scripts/operational-formative-conversation-v5-v7-process-local-runner.mjs",
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v7",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v7",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v7-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v7-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v7-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v7/compiler.ts"
  },
  {
...
const protocol: Record<string, unknown> = {
  ...v4Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v7",
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v7",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v7",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
