...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v11/security-release";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v11/fixture-source";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v11/live-environment";
import {
...
const FROZEN_V10_RUNTIME_CANDIDATE_HASH =
...
function writeJson(relativePath: string, value: unknown) {
  ...
  if (!existsSync(outputPath)) {
    throw new Error(
      `formative_conversation_v11_tracked_artifact_missing:${relativePath}`
    );
  }
  if (readFileSync(outputPath, "utf8") !== serialized) {
    throw new Error(
      `formative_conversation_v11_tracked_artifact_drift:${relativePath}`
    );
  }
}
...
function copyOrVerify(sourcePath: string, targetPath: string) {
  ...
  if (
    ...
    throw new Error(
      `formative_conversation_v11_preserved_evidence_drift:${path.relative(process.cwd(), targetPath)}`
    );
  }
}
...
const runtimeCandidateDraft = structuredClone(frozenV10Candidate);
const runtimeFingerprint = runtimeCandidateDraft.configuration_fingerprint;
if (!runtimeFingerprint) {
  throw new Error("formative_conversation_v5_v11_runtime_fingerprint_missing");
}
const formativeRoleMetadata =
  runtimeFingerprint.role_version_metadata.formative_conversation_agent;
if (!formativeRoleMetadata) {
  throw new Error("formative_conversation_v5_v11_role_metadata_missing");
}
if (
  ...
  throw new Error("formative_conversation_v5_v11_v10_runtime_fingerprint_drift");
}
...
if (
  ...
  frozenV10RuntimeCandidateHash !== FROZEN_V10_RUNTIME_CANDIDATE_HASH ||
  ...
  runtimeCandidateHash !== FROZEN_V10_RUNTIME_CANDIDATE_HASH
) {
  throw new Error(
    "formative_conversation_v5_v11_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v11_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    path: "scripts/operational-formative-conversation-v5-v11-launcher.mjs",
    child_cli_path:
...
const sourceConfiguration = {
  ...
  source_code_references: {
    ...
    run_scoped_provenance:
      "src/lib/operational/formative-conversation-v5-evaluation-v11/provenance.ts",
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v11/live-environment.ts",
    launch_mechanism:
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v11",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v11-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v11-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v11-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/compiler.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/security-release.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v11/provenance.ts"
  },
  {
  ...
  },
  {
    ...
    path: FORMATIVE_CONVERSATION_V5_V11_REMOTE_CANARY_EVIDENCE_PATH
  },
  {
...
let committedSourceVerification: ReturnType<
  typeof verifyFormativeConversationV11CommittedSource
> | null = null;
...
const provenanceRoot = absolute(
  ".data/operational-formative-conversation-v5-evaluation-v11/provenance"
);
...
const materializationProvenance = {
  artifact_version:
    "formative-conversation-v11-materialization-provenance-v1",
