...
import { validateFormativeConversationV5LiveEnvironment } from "../src/lib/operational/formative-conversation-v5-evaluation-v17/live-environment";
import {
...
import { assertFormativeConversationV5LivePreflight } from "../src/lib/operational/formative-conversation-v5-evaluation-v17/service";
import {
  buildFormativeConversationV5TestEnvironment,
  installFormativeConversationV5TestEnvironment
} from "./helpers/formative-conversation-v5-v17-test-environment";
...
try {
  ...
  delete missingMigrations.FORMATIVE_CONVERSATION_V5_V17_MIGRATIONS_CURRENT;
  assert.throws(
    () =>
      validateFormativeConversationV5LiveEnvironment({
        ...validationInput,
