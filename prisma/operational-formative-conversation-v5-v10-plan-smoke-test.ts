...
const TEST_RESEARCH_KEY =
  "formative-conversation-v10-plan-research-key-000000000000";
...
function main() {
  ...
  assert.equal(
    child.status,
    0,
    child.stderr.trim() || child.error?.message || "V10 plan failed."
  );
    ...
    JSON.stringify({
      ...
      error_code:
        error instanceof Error
          ...
          : "formative_conversation_v10_plan_smoke_failed",
      provider_calls: 0,
      provider_network_requests: 0,
