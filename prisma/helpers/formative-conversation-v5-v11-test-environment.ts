...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv11deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V11_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V11_APPROVAL_PATH_PROJECTION_USED: "false",
