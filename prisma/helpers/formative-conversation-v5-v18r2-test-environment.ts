...
export function buildFormativeConversationV5TestEnvironment(
  ...
  const env = {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv18r2deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V18R2_CANONICAL_SERVICE_NAME:
      "conversational-mcq",
    FORMATIVE_CONVERSATION_V5_V18R2_MIGRATIONS_CURRENT: "true",
    FORMATIVE_CONVERSATION_V5_V18R2_LIVE_EVALUATION_ENABLED: "true",
    FORMATIVE_CONVERSATION_V5_V18R2_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V18R2_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V18R2_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V18R2_DATABASE_IDENTITY_MATCHED: "true",
