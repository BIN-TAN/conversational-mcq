...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv14deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V14_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V14_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V14_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V14_DATABASE_IDENTITY_MATCHED: "true",
