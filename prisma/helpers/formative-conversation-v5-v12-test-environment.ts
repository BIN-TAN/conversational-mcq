...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv12deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V12_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V12_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V12_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V12_DATABASE_IDENTITY_MATCHED: "true",
