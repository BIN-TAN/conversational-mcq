...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv13deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V13_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V13_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V13_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V13_DATABASE_IDENTITY_MATCHED: "true",
