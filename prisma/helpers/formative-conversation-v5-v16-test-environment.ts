...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv16deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V16_CANONICAL_SERVICE_NAME:
      "conversational-mcq",
    FORMATIVE_CONVERSATION_V5_V16_MIGRATIONS_CURRENT: "true",
    FORMATIVE_CONVERSATION_V5_V16_LIVE_EVALUATION_ENABLED: "true",
    FORMATIVE_CONVERSATION_V5_V16_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V16_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V16_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V16_DATABASE_IDENTITY_MATCHED: "true",
