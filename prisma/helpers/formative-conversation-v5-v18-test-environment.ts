...
export function buildFormativeConversationV5TestEnvironment(
  ...
  const env = {
    ...
    FORMATIVE_CONVERSATION_V5_V18_CANONICAL_SERVICE_NAME:
      "conversational-mcq",
    FORMATIVE_CONVERSATION_V5_V18_MIGRATIONS_CURRENT: "true",
    FORMATIVE_CONVERSATION_V5_V18_LIVE_EVALUATION_ENABLED: "true",
    FORMATIVE_CONVERSATION_V5_V18_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V18_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V18_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V18_DATABASE_IDENTITY_MATCHED: "true",
    FORMATIVE_CONVERSATION_V5_V18_LAUNCHER_VERSION:
      FORMATIVE_CONVERSATION_V5_LAUNCHER_VERSION,
    FORMATIVE_CONVERSATION_V5_V18_LAUNCH_MECHANISM:
      FORMATIVE_CONVERSATION_V5_LAUNCH_MECHANISM,
    FORMATIVE_CONVERSATION_V5_V18_CANONICAL_LAUNCHER_VALIDATED: "true",
