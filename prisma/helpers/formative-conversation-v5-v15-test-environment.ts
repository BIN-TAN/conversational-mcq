...
export function buildFormativeConversationV5TestEnvironment(
  ...
  Object.assign(env, {
    ...
    OPENAI_API_KEY:
      ["sk", "formativeconversationv15deterministictest000000"].join("-"),
    ...
    FORMATIVE_CONVERSATION_V5_V15_CANONICAL_SERVICE_NAME:
      "conversational-mcq",
    FORMATIVE_CONVERSATION_V5_V15_MIGRATIONS_CURRENT: "true",
    FORMATIVE_CONVERSATION_V5_V15_LIVE_EVALUATION_ENABLED: "true",
    FORMATIVE_CONVERSATION_V5_V15_ENVIRONMENT_SOURCE: "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V15_APPROVAL_PATH_PROJECTION_USED: "false",
    FORMATIVE_CONVERSATION_V5_V15_DATABASE_CONNECTION_SOURCE:
      "deterministic_test",
    FORMATIVE_CONVERSATION_V5_V15_DATABASE_IDENTITY_MATCHED: "true",
