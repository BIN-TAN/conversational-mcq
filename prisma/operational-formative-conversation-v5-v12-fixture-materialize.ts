...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v12/security-release";
import {
  FORMATIVE_CONVERSATION_V12_RUN_PROVENANCE_VERSION
} from "../src/lib/operational/formative-conversation-v5-evaluation-v12/provenance";
import {
  verifyFormativeConversationV12CommittedSource
} from "../src/lib/operational/formative-conversation-v5-evaluation-v12/provenance";
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v12/fixture-source";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v12/live-environment";
import {
...
function writeJson(relativePath: string, value: unknown) {
  ...
  if (!existsSync(outputPath)) {
    throw new Error(
      `formative_conversation_v12_tracked_artifact_missing:${relativePath}`
    );
  }
  if (readFileSync(outputPath, "utf8") !== serialized) {
    throw new Error(
      `formative_conversation_v12_tracked_artifact_drift:${relativePath}`
    );
  }
}
...
function copyOrVerify(sourcePath: string, targetPath: string) {
  ...
  if (
    ...
    throw new Error(
      `formative_conversation_v12_preserved_evidence_drift:${path.relative(process.cwd(), targetPath)}`
    );
  }
}
...
const runtimeCandidateDraft = structuredClone(frozenV11Candidate);
const runtimeFingerprint = runtimeCandidateDraft.configuration_fingerprint;
if (!runtimeFingerprint) {
  throw new Error("formative_conversation_v5_v12_runtime_fingerprint_missing");
}
const formativeRoleMetadata =
  runtimeFingerprint.role_version_metadata.formative_conversation_agent;
if (!formativeRoleMetadata) {
  throw new Error("formative_conversation_v5_v12_role_metadata_missing");
}
if (
  ...
  throw new Error("formative_conversation_v5_v12_v11_runtime_fingerprint_drift");
}
...
if (
  ...
  runtimeCandidateHash !== FROZEN_V11_RUNTIME_CANDIDATE_HASH
) {
  throw new Error(
    "formative_conversation_v5_v12_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v12_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    canonical_invocation:
      "node --import tsx",
    path: "scripts/operational-formative-conversation-v5-v12-launcher.mjs",
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v12",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V12_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    run_scoped_provenance:
      "src/lib/operational/formative-conversation-v5-evaluation-v12/provenance.ts",
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v12/live-environment.ts",
    launch_mechanism:
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v12",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v12",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v12-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v12-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v12-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/compiler.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/security-release.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v12/provenance.ts"
  },
  {
  ...
  },
  {
    ...
    path: FORMATIVE_CONVERSATION_V5_V12_REMOTE_CANARY_EVIDENCE_PATH
  },
  {
...
const protocol: Record<string, unknown> = {
  ...v9Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v12",
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v12",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v12",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
...
let committedSourceVerification: ReturnType<
  typeof verifyFormativeConversationV12CommittedSource
> | null = null;
...
const provenanceRoot = absolute(
  ".data/operational-formative-conversation-v5-evaluation-v12/provenance"
);
...
const materializationProvenance = {
  artifact_version:
    "formative-conversation-v12-materialization-provenance-v1",
