...
import { validateFormativeConversationV5LiveEnvironment } from "../src/lib/operational/formative-conversation-v5-evaluation-v15/live-environment";
import {
...
import { assertFormativeConversationV5LivePreflight } from "../src/lib/operational/formative-conversation-v5-evaluation-v15/service";
import {
  buildFormativeConversationV5TestEnvironment,
  installFormativeConversationV5TestEnvironment
} from "./helpers/formative-conversation-v5-v15-test-environment";
...
try {
  ...
  delete missingMigrations.FORMATIVE_CONVERSATION_V5_V15_MIGRATIONS_CURRENT;
  assert.throws(
    () =>
      validateFormativeConversationV5LiveEnvironment({
        ...validationInput,
