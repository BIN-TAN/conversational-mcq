...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v9/fixture-source";
import {
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    path: "scripts/operational-formative-conversation-v5-v9-launcher.mjs",
    child_cli_path:
      "prisma/operational-formative-conversation-v5-v9-evaluate.ts",
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v9",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V9_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v9/live-environment.ts",
    launch_mechanism:
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v9",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v9",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v9-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v9-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v9-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v9/compiler.ts"
  },
  {
...
const protocol: Record<string, unknown> = {
  ...v7Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v9",
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v9",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v9",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
