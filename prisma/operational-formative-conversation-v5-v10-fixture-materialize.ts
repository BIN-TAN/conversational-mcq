...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v10/fixture-source";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v10/live-environment";
import {
...
const runtimeCandidateDraft = structuredClone(failedV9Candidate);
runtimeCandidateDraft.manifest_version =
  "candidate-operational-agent-config-gpt-5.6-full-v2-formative-conversation-v10";
runtimeCandidateDraft.candidate_profile_name =
  "GPT-5.6 full operational stack with formative conversation V10 bounded semantic regeneration";
const runtimeFingerprint = runtimeCandidateDraft.configuration_fingerprint;
if (!runtimeFingerprint) {
  throw new Error("formative_conversation_v5_v10_runtime_fingerprint_missing");
}
...
if (!formativeRoleMetadata) {
  throw new Error("formative_conversation_v5_v10_role_metadata_missing");
}
...
if (
  ...
  throw new Error(
    "formative_conversation_v5_v10_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v10_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    path: "scripts/operational-formative-conversation-v5-v10-launcher.mjs",
    child_cli_path:
      "prisma/operational-formative-conversation-v5-v10-evaluate.ts",
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v10",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V10_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v10/live-environment.ts",
    launch_mechanism:
      "scripts/operational-formative-conversation-v5-v10-launcher.mjs",
    secure_process_local_injection:
      "scripts/operational-formative-conversation-v5-v10-process-local-runner.mjs",
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v10",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v10",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v10-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v10-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v10-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v10/compiler.ts"
  },
  {
  ...
  },
  {
    ...
    path: FORMATIVE_CONVERSATION_V5_V10_REMOTE_CANARY_EVIDENCE_PATH
  }
].map((entry) => ({
  ...entry,
...
const protocol: Record<string, unknown> = {
  ...v9Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v10",
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v10",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v10",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
