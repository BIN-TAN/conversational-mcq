...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v6/compiler";
import {
  formativeConversationV5FixtureSources
} from "../src/lib/operational/formative-conversation-v5-evaluation-v6/fixture-source";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v6/live-environment";
...
if (
  ...
  throw new Error(
    "formative_conversation_v5_v6_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v6_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    path: "scripts/operational-formative-conversation-v5-v6-launcher.mjs",
    child_cli_path:
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v6",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V6_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v6/live-environment.ts",
    launch_mechanism:
      "scripts/operational-formative-conversation-v5-v6-launcher.mjs",
    secure_process_local_injection:
      "scripts/operational-formative-conversation-v5-v6-process-local-runner.mjs",
    protocol_case_compiler:
      "src/lib/operational/formative-conversation-v5-evaluation-v6/compiler.ts",
    protocol_runner:
      "src/lib/operational/formative-conversation-v5-evaluation-v6/service.ts",
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v6",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v6",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v6-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v6-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v6-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v6/compiler.ts"
  },
  {
...
const protocol: Record<string, unknown> = {
  ...v4Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v6",
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v6",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v6",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
