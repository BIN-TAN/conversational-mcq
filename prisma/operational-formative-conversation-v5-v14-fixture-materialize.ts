...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/security-release";
import {
  FORMATIVE_CONVERSATION_V14_RUN_PROVENANCE_VERSION
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/provenance";
import { FORMATIVE_CONVERSATION_V14_EVALUATION_ACCOUNTING_VERSION } from "../src/lib/operational/formative-conversation-v5-evaluation-v14/evaluation-accounting";
import {
  verifyFormativeConversationV14CommittedSource
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/provenance";
...
import {
  ...
  FORMATIVE_CONVERSATION_V5_V13_CASE5_EVIDENCE_CLOSURE_REPLAY_PATH,
  FORMATIVE_CONVERSATION_V5_V13_FAILURE_ANALYSIS_PATH,
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/contracts";
import {
  compileFormativeConversationV5ExecutionPlan
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/compiler";
import {
  formativeConversationV5FixtureSources
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/fixture-source";
import {
...
} from "../src/lib/operational/formative-conversation-v5-evaluation-v14/live-environment";
import {
...
const FAILED_V13_RUNTIME_CANDIDATE_HASH =
  "3ed4ead09470a9f407d106817208eafa27f4baa184cc3f52d52c94c94c45d378";
const FAILED_V13_PROTOCOL_HASH =
  "cbf65197ccd744e90261bb5a8bb1ec14b71142f6fa49bdd5b996e7a2a2142d1b";
const FAILED_V13_SOURCE_COMMIT =
  "5085e3aa92a97cc0351e07aa1ffbed1662930443";
const FAILED_V13_PROVIDER_RUN_ID =
  "fcv5v13_provider_20260803174047_46ca2888";
const FAILED_V13_DERIVED_EVALUATION_ID =
  "fcv5v13_derived_20260803174047_e1102d9a";
...
function writeJson(relativePath: string, value: unknown) {
  ...
  if (!existsSync(outputPath)) {
    throw new Error(
      `formative_conversation_v14_tracked_artifact_missing:${relativePath}`
    );
  }
  if (readFileSync(outputPath, "utf8") !== serialized) {
    throw new Error(
      `formative_conversation_v14_tracked_artifact_drift:${relativePath}`
    );
  }
}
...
function copyOrVerify(sourcePath: string, targetPath: string) {
  ...
  if (
    ...
    throw new Error(
      `formative_conversation_v14_preserved_evidence_drift:${path.relative(process.cwd(), targetPath)}`
    );
  }
}
...
if (!runtimeFingerprint) {
  throw new Error("formative_conversation_v5_v14_runtime_fingerprint_missing");
}
const formativeRoleMetadata =
  runtimeFingerprint.role_version_metadata.formative_conversation_agent;
if (!formativeRoleMetadata) {
  throw new Error("formative_conversation_v5_v14_role_metadata_missing");
}
if (
  ...
  throw new Error("formative_conversation_v5_v14_v11_runtime_fingerprint_drift");
}
...
runtimeFingerprint.deterministic_guard_versions = {
  ...
  formative_conversation_safe_invalid_output_evidence:
    FORMATIVE_CONVERSATION_SAFE_INVALID_OUTPUT_EVIDENCE_VERSION,
  formative_conversation_transition_evidence_closure:
    FORMATIVE_CONVERSATION_TRANSITION_EVIDENCE_CLOSURE_VERSION,
  formative_conversation_evaluation_accounting:
...
if (
  ...
  throw new Error(
    "formative_conversation_v5_v14_runtime_candidate_identity_invalid"
  );
}
if (
  ...
  throw new Error(
    "formative_conversation_v5_v14_model_or_runtime_policy_changed"
  );
}
...
const liveEnvironmentContract = {
  ...
  launcher: {
    ...
    canonical_invocation:
      "node --import tsx",
    path: "scripts/operational-formative-conversation-v5-v14-launcher.mjs",
    ...
    invalid_invocation_error_code:
      "formative_conversation_v14_canonical_loader_required",
...
const sourceConfiguration = {
  artifact_version:
    "formative-conversation-v5-executable-source-configuration-v14",
  ...
  required_environment: {
    ...
    FORMATIVE_CONVERSATION_V5_V14_LIVE_EVALUATION_ENABLED: true
  },
  ...
  source_code_references: {
    ...
    run_scoped_provenance:
      "src/lib/operational/formative-conversation-v5-evaluation-v14/provenance.ts",
    ...
    live_environment_parity:
      "src/lib/operational/formative-conversation-v5-evaluation-v14/live-environment.ts",
    launch_mechanism:
...
const candidateManifest = {
  manifest_version:
    "formative-conversation-host-v5-executable-candidate-revision-v14",
...
const fixtureManifest = {
  manifest_version: "formative-conversation-v5-fixture-manifest-v14",
...
const v13Case5EvidenceClosureReplay = {
  artifact_version:
    "formative-conversation-v14-immutable-v13-case5-evidence-closure-replay-v1",
  immutable_source: {
    source_commit_sha: FAILED_V13_SOURCE_COMMIT,
    runtime_candidate_hash: FAILED_V13_RUNTIME_CANDIDATE_HASH,
    evaluation_protocol_hash: FAILED_V13_PROTOCOL_HASH,
    provider_run_id: FAILED_V13_PROVIDER_RUN_ID,
    derived_evaluation_id: FAILED_V13_DERIVED_EVALUATION_ID,
    case_id: "fcv5_05_sound_profile_transition",
    case_transcript_sha256:
      "ab8ae6c64017f45769bcf6b62253d09480073aac7bc2875a76308dd2bba963b8",
    aggregate_evaluation_sha256:
      "ade10c69883ffc476a2ba3cab470418a86ca0704f2f43c0300f198c69faa384a"
  },
  observed_failure: {
    canonical_transition_evidence_turns: [788, 790],
    referenced_transition_evidence_turns: [788, 789, 790],
    missing_from_canonical_evidence_turns: [789],
    original_invalid_candidate_hash:
      "e16d17a7987749d475ecd00b5dcde5bbb4126b815e1c95db6787c3a1baf72842",
    regenerated_invalid_candidate_hash:
      "929e11532d88832ca7f117ee9497f48750ba98f7452a63ce8eee15c6e282df44",
    original_transition_persisted: false,
    partial_transition_created: false,
    conversation_turn_preserved: true,
    v13_validation_issue_path:
      "profile_transition_recommendation.field_evidence"
  },
  v14_expected_replay: {
    invalid_recommendation_rejected: true,
    typed_reason:
      "profile_transition_evidence_closure_violation",
    corrected_canonical_evidence_turns: [788, 789, 790],
    corrected_recommendation_accepted: true,
    duplicate_transition_count: 0
  },
  v13_evidence_preserved_immutable: true,
  provider_calls: 0,
  model_auth_requests: 0,
  dispatch_checkpoints: 0
};
writeJson(
  FORMATIVE_CONVERSATION_V5_V13_CASE5_EVIDENCE_CLOSURE_REPLAY_PATH,
  v13Case5EvidenceClosureReplay
);

const v13FailureAnalysis = {
  artifact_version:
    "formative-conversation-v14-v13-failure-analysis-v1",
  immutable_source: v13Case5EvidenceClosureReplay.immutable_source,
  classification: "p1_provenance_contract_defect",
  root_cause:
    "The transition contract accepted references from field evidence that were absent from the canonical top-level transition evidence set.",
  secondary_accounting_defect:
    "Authorized semantic regeneration calls were compared with the frozen base call graph instead of being reported as recovery calls.",
  corrections: [
    "Validate closure across field evidence, supporting observations, rationale evidence represented by field evidence, and cited student turns at the final acceptance boundary.",
    "Preserve invalid original and regenerated recommendations with a typed closure reason and create no partial transition.",
    "Report base logical calls and authorized recovery calls separately while retaining total provider-attempt accounting."
  ],
  excluded_changes: [
    "teaching_prompt",
    "formative_pedagogy",
...
const runnerImplementationFiles = [
  {
    ...
    path: "scripts/operational-formative-conversation-v5-v14-process-local-runner.mjs"
  },
  {
    role: "launcher",
    path: "scripts/operational-formative-conversation-v5-v14-launcher.mjs"
  ...
  {
    role: "cli",
    path: "prisma/operational-formative-conversation-v5-v14-evaluate.ts"
  },
  {
    role: "orchestration_service",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/service.ts"
  },
  {
    role: "environment_parity_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/live-environment.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/candidate-runner.ts"
  },
  {
    role: "package_validator",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/package.ts"
  },
  {
    role: "contract_schemas",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/contracts.ts"
  },
  {
    role: "case_compiler",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/compiler.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/adversarial-matrix.ts"
  },
  ...
  {
    role: "transition_evidence_closure",
    path: "src/lib/services/student-assessment/formative-conversation/transition-evidence-closure.ts"
  },
  {
    role: "evaluation_accounting",
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/evaluation-accounting.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/security-release.ts"
  },
  {
  ...
  },
  {
    ...
    path: "src/lib/operational/formative-conversation-v5-evaluation-v14/provenance.ts"
  },
  {
  ...
  },
  {
    ...
    path: FORMATIVE_CONVERSATION_V5_V14_REMOTE_CANARY_EVIDENCE_PATH
  },
  {
  ...
  {
    role: "immutable_v13_case5_evidence_closure_replay",
    path: FORMATIVE_CONVERSATION_V5_V13_CASE5_EVIDENCE_CLOSURE_REPLAY_PATH
  },
  {
    role: "v13_failure_analysis",
    path: FORMATIVE_CONVERSATION_V5_V13_FAILURE_ANALYSIS_PATH
  }
].map((entry) => ({
  ...entry,
...
const protocol: Record<string, unknown> = {
  ...v9Protocol,
  protocol_version:
    "formative-conversation-host-v5-executable-evaluation-v14",
  ...
  target_identity: {
    ...
    transition_evidence_closure_version:
      targetRoleIdentity.transition_evidence_closure_version,
    evaluation_accounting_version:
      targetRoleIdentity.evaluation_accounting_version,
    student_output_format_version:
...
const approvalPlaceholder = {
  artifact_version:
    "formative-conversation-v5-executable-approval-placeholder-v14",
...
const candidateIdentity = {
  artifact_version:
    "formative-conversation-v5-executable-candidate-identity-v14",
  approval_state: "candidate_not_approved",
  activation_permitted: false,
...
let committedSourceVerification: ReturnType<
  typeof verifyFormativeConversationV14CommittedSource
> | null = null;
...
const provenanceRoot = absolute(
  ".data/operational-formative-conversation-v5-evaluation-v14/provenance"
);
...
const materializationProvenance = {
  artifact_version:
    "formative-conversation-v14-materialization-provenance-v1",
