...
import { validateFormativeConversationV5LiveEnvironment } from "../src/lib/operational/formative-conversation-v5-evaluation-v18r2/live-environment";
import {
...
} from "./helpers/formative-conversation-v5-v18r2-test-environment";
...
try {
  ...
  delete missingMigrations.FORMATIVE_CONVERSATION_V5_V18R2_MIGRATIONS_CURRENT;
  assert.throws(
    () =>
      validateFormativeConversationV5LiveEnvironment({
        ...validationInput,
