...
function assertCanonicalLauncher(options: Options) {
  if (
    process.env
      ...
      "true" ||
    process.env.FORMATIVE_CONVERSATION_V5_V12_CANONICAL_LOADER_VERSION !==
  ...
  if (
    ...
    throw new Error(
      "formative_conversation_v12_canonical_outer_loader_required"
    );
  }
}
...
const databaseOwner = createEvaluationDatabaseConnectionOwner({
  client: prisma,
  client_id: "formative-conversation-v12-evaluation-prisma",
