    ...
    JSON.stringify(
      {
        ...
        auth_version_incremented: result.auth_version_incremented ?? false,
        ...
        tokens_invalidated_count: result.invalidated_token_count ?? 0,
        audit_event_public_id: result.audit_event_public_id ?? null,
