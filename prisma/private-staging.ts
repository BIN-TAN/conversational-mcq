...
function walkthroughMarkdown() {
  ...
  return [
    ...
    "- [ ] Student login with `phase8d_student_01` and the shared access code.",
    "- [ ] Start the private staging assessment.",
    "- [ ] Complete initial item administration without seeing correctness feedback.",
    "- [ ] Send a free-text reasoning message to exercise Response Collection.",
    "- [ ] Save and exit, then log back in and resume.",
    "- [ ] Try an off-topic/help/correctness request and confirm the student UI remains neutral.",
    "- [ ] Continue through follow-up/progression as available.",
    "- [ ] Teacher opens Student sessions and reviews the session detail.",
    "- [ ] Teacher confirms agent audit/effective-result fields are visible only on teacher surfaces.",
    "- [ ] Teacher generates a master CSV export and confirms no secrets/internal UUIDs are visible.",
