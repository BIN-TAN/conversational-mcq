...
function conversationContext(
  ...
  return compileFormativeConversationContext({
    conversation_public_id: "conversation_v13_adversarial",
    assessment_public_id: "assessment_v13_adversarial",
    concept_unit_public_id: "concept_v13_adversarial",
...
function main() {
  ...
  assert.equal(
    formativeConversationV13AdversarialMatrix.provider_execution_permitted,
    false
  );
  assert.equal(
    formativeConversationV13AdversarialMatrix
  ...
  const longContext = compileFormativeConversationContext({
    conversation_public_id: "conversation_v13_long_context",
    assessment_public_id: "assessment_v13_long_context",
    concept_unit_public_id: "concept_v13_long_context",
    ...
    intervention_history: [],
    memory: {
      snapshot_public_id: "memory_v13_long_context",
      snapshot_index: 1,
  ...
  console.log(
    JSON.stringify(
      {
        status: "passed",
        matrix_hash: FORMATIVE_CONVERSATION_V13_ADVERSARIAL_MATRIX_HASH,
        opening_categories:
          formativeConversationV13AdversarialMatrix.categories.opening.length,
