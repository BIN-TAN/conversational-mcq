...
import { FORMATIVE_CONVERSATION_V5_RUN_OUTPUT_ROOT } from "../src/lib/operational/formative-conversation-v5-evaluation-v18r1/contracts";
import { validateFormativeConversationV5LiveEnvironment } from "../src/lib/operational/formative-conversation-v5-evaluation-v18r1/live-environment";
import {
  exactFormativeConversationV18LiveAuthorization,
  loadFormativeConversationV18EvaluationPackage
} from "../src/lib/operational/formative-conversation-v5-evaluation-v18r1/package";
import {
  buildFormativeConversationV5TestEnvironment,
  installFormativeConversationV5TestEnvironment
} from "./helpers/formative-conversation-v5-v18r1-test-environment";
...
try {
  ...
  delete missingMigrations.FORMATIVE_CONVERSATION_V5_V18R1_MIGRATIONS_CURRENT;
  assert.throws(
    () =>
      validateFormativeConversationV5LiveEnvironment({
        ...validationInput,
  ...
  console.log(
    JSON.stringify({
      ...
      deployed_provenance_mode_explicit: true,
      executable_freeze_prepared_not_live: true,
      provider_calls: 0,
