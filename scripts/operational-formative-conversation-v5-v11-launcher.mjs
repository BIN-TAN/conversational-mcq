...
const LOCAL_PATH_PROJECTION = {
  ...
  OPERATIONAL_APPROVAL_EVIDENCE_PATH:
    "FORMATIVE_CONVERSATION_V5_V11_LOCAL_APPROVAL_EVIDENCE_PATH"
};
const SOURCE_PATH_ENV = {
  OPERATIONAL_APPROVAL_BUNDLE_PATH:
    "FORMATIVE_CONVERSATION_V5_V11_SOURCE_APPROVAL_BUNDLE_PATH",
  OPERATIONAL_APPROVED_MANIFEST_PATH:
    "FORMATIVE_CONVERSATION_V5_V11_SOURCE_APPROVED_MANIFEST_PATH",
  OPERATIONAL_APPROVAL_EVIDENCE_PATH:
    "FORMATIVE_CONVERSATION_V5_V11_SOURCE_APPROVAL_EVIDENCE_PATH"
};
const LOCAL_DATABASE_URL =
  "FORMATIVE_CONVERSATION_V5_V11_LOCAL_DATABASE_URL";
...
function childEnvironment() {
  ...
  if (projectionEntries.length > 0) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V11_APPROVAL_PATH_PROJECTION_USED =
      "true";
    child.FORMATIVE_CONVERSATION_V5_V11_ENVIRONMENT_SOURCE ??=
  ...
  if (configured(process.env[LOCAL_DATABASE_URL])) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V11_DATABASE_CONNECTION_SOURCE =
      "render_external_process_local";
    child.FORMATIVE_CONVERSATION_V5_V11_DATABASE_IDENTITY_MATCHED =
      "true";
  ...
  child.FORMATIVE_CONVERSATION_V5_V11_LAUNCHER_VERSION =
    LAUNCHER_VERSION;
  child.FORMATIVE_CONVERSATION_V5_V11_LAUNCH_MECHANISM =
    LAUNCH_MECHANISM;
  for (const name of [
    "FORMATIVE_CONVERSATION_V5_V11_ENVIRONMENT_SOURCE",
    "FORMATIVE_CONVERSATION_V5_V11_APPROVAL_PATH_PROJECTION_USED",
    "FORMATIVE_CONVERSATION_V5_V11_DATABASE_CONNECTION_SOURCE",
    "FORMATIVE_CONVERSATION_V5_V11_DATABASE_IDENTITY_MATCHED",
    "FORMATIVE_CONVERSATION_V5_V11_LAUNCHER_VERSION",
    "FORMATIVE_CONVERSATION_V5_V11_LAUNCH_MECHANISM"
  ]) {
    if (configured(child[name])) {
      injectedKeys.add(name);
    }
  }
  child.FORMATIVE_CONVERSATION_V5_V11_INJECTED_ENVIRONMENT_KEYS =
