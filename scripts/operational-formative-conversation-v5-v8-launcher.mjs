...
function childEnvironment() {
  ...
  if (projectionEntries.length > 0) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V8_APPROVAL_PATH_PROJECTION_USED =
      "true";
    child.FORMATIVE_CONVERSATION_V5_V8_ENVIRONMENT_SOURCE ??=
  ...
  if (configured(process.env[LOCAL_DATABASE_URL])) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V8_DATABASE_CONNECTION_SOURCE =
      "render_external_process_local";
    child.FORMATIVE_CONVERSATION_V5_V8_DATABASE_IDENTITY_MATCHED =
      "true";
  ...
  child.FORMATIVE_CONVERSATION_V5_V8_LAUNCHER_VERSION =
    LAUNCHER_VERSION;
  child.FORMATIVE_CONVERSATION_V5_V8_LAUNCH_MECHANISM =
    LAUNCH_MECHANISM;
  for (const name of [
    "FORMATIVE_CONVERSATION_V5_V8_ENVIRONMENT_SOURCE",
    "FORMATIVE_CONVERSATION_V5_V8_APPROVAL_PATH_PROJECTION_USED",
  ...
  child.FORMATIVE_CONVERSATION_V5_V8_INJECTED_ENVIRONMENT_KEYS =
