...
const LOCAL_PATH_PROJECTION = {
  OPERATIONAL_APPROVAL_BUNDLE_PATH:
    "FORMATIVE_CONVERSATION_V5_V7_LOCAL_APPROVAL_BUNDLE_PATH",
  OPERATIONAL_APPROVED_MANIFEST_PATH:
    "FORMATIVE_CONVERSATION_V5_V7_LOCAL_APPROVED_MANIFEST_PATH",
  OPERATIONAL_APPROVAL_EVIDENCE_PATH:
    "FORMATIVE_CONVERSATION_V5_V7_LOCAL_APPROVAL_EVIDENCE_PATH"
};
...
const LOCAL_DATABASE_URL =
  "FORMATIVE_CONVERSATION_V5_V7_LOCAL_DATABASE_URL";
...
function childEnvironment() {
  ...
  if (projectionEntries.length > 0) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V7_APPROVAL_PATH_PROJECTION_USED =
      "true";
    child.FORMATIVE_CONVERSATION_V5_V7_ENVIRONMENT_SOURCE ??=
  ...
  if (configured(process.env[LOCAL_DATABASE_URL])) {
    ...
    child.FORMATIVE_CONVERSATION_V5_V7_DATABASE_CONNECTION_SOURCE =
      "render_external_process_local";
    child.FORMATIVE_CONVERSATION_V5_V7_DATABASE_IDENTITY_MATCHED =
      "true";
  ...
  child.FORMATIVE_CONVERSATION_V5_V7_LAUNCHER_VERSION =
    LAUNCHER_VERSION;
  child.FORMATIVE_CONVERSATION_V5_V7_LAUNCH_MECHANISM =
    LAUNCH_MECHANISM;
  for (const name of [
  ...
  child.FORMATIVE_CONVERSATION_V5_V7_INJECTED_ENVIRONMENT_KEYS =
